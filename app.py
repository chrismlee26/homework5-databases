...
def create():
    ...
    if request.method == 'POST':
        ...
        return redirect(url_for('detail', plant_id='{new_plant}'))
...
def edit(plant_id):
    ...
    if request.method == 'POST':
        ...
        updated_id = mongo.db.plants.update_one( {
        ...
        return redirect(url_for('detail', plant_id=updated_id))
    else:
...
def delete(plant_id):
    ...
    # the given plant id.
    mongo.db.plants.delete_many({'_id': ObjectId(plant_id)})
